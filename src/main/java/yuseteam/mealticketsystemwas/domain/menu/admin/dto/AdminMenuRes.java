...
@Builder
@AllArgsConstructor
@Schema(description = "관리자 메뉴 조회 응답 DTO")
public class AdminMenuRes {
    ...
    @Schema(description = "메뉴 이미지 URL", example = "https://s3.amazonaws.com/happinessql/menu1.jpg")
    ...
    @Schema(description = "식당 이름", example = "Yummy 학식당")
